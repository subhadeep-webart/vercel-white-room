...
export async function DELETE(request) {
  try {
    ...
    const existingConcerts =
      page.components[componentIndex].data.concerts || [];

    const updatedConcerts = existingConcerts.filter(
      (concert) => concert._id?.toString() !== _id
    );
