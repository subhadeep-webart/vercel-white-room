...
import { getWithBookingFormValidationSchema } from "@/utils/formValidationSchema";
...
const GetWithBookingForm = ({ defaultValues = {}, refetch }) => {
  const {
  ...
  const {
    ...
    resolver: yupResolver(getWithBookingFormValidationSchema),
    defaultValues: {
  ...
  const onSubmit = async (data) => {
    try {
      const payload = { type: "get_with_booking", data: data };
...
export default GetWithBookingForm;
