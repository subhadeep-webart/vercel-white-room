...
import { commonBannerValidationSchema } from "@/utils/formValidationSchema";
...
const CommonBannerForm = ({
  ...
  const {
    ...
    resolver: yupResolver(commonBannerValidationSchema),
    defaultValues: {
      file_url: "",
      title: "",
    },
    ...
    <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="w-full relative">
          ...
          <Input id="title" placeholder="Banner Title" {...register("title")} />
...
export default CommonBannerForm;
