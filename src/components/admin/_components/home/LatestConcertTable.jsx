...
const LatestConcertTable = ({ columns, data, refetch }) => {
  const { deleteConcert, loading } = useDeleteConcert(refetch);
                    ...
                    >
                      {col.accessorKey === "actions" ? (
                        <div className="flex justify-end gap-2">
                          <Link
                            href={`/admin/dashboard/home/latest-concerts/edit-latest-concert/${row?._id}`}
                          ...
                          <AlertBox onDelete={deleteConcert} rowData={row} />
                        </div>
...
export default LatestConcertTable;
