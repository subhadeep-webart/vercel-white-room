...
const PressCoverageTable = ({ columns, data, refetch }) => {
  const { handleDeletePressCoverage, loading } =
    useDeletePressCoverage(refetch);
                  ...
                  >
                    {col.accessorKey === "actions" ? (
                      <div className="flex justify-end gap-2">
                        ...
                        <AlertBox
                          onDelete={handleDeletePressCoverage}
                          rowData={row}
                        />
                      </div>
                    ) : col.accessorKey === "poster_image" ||
                      col.accessorKey === "song_image" ? (
                      row[col.accessorKey] ? (
