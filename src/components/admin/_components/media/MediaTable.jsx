...
const MediaTable = ({ data, refetch }) => {
    ...
    const { handleDeleteMedia, loading: isMediaDeleting } = useDeleteMediaById(refetch);
                                        ...
                                        >
                                            {col.accessorKey === "actions" ? (
                                                <div className="flex justify-end gap-2">
                                                    ...
                                                    <AlertBox onDelete={handleDeleteMedia} rowData={row} />
                                                </div>
                                            ) : row[col.accessorKey] && col.accessorKey === "file_url" ? (
