...
const OnTheDayContentForm = ({ isEdited = false, defaultValues = {} }) => {
  const { handleAddOnTheDaySection, loading: isNewSectionAdded } =
    useAddOnTheDaySection();
  const { handleUpdateOnTheDayContent, loading: isUpdating } =
    useUpdateOnTheDayContent();
  ...
  return (
    <form
      className="space-y-6 bg-white py-4 px-4 shadow-2xl"
