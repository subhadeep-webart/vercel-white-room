...
const AddClientModal = ({ openAddClientModal, setOpenAddClientModal, onClientAdd }) => {
    const {
        register,
        handleSubmit,
        reset,
                    ...
                    <form className="space-y-8" onSubmit={handleSubmit(onSubmit)}>
                        <div className="grid grid-cols-1 gap-6">
                            <div className="w-full relative flex flex-col gap-2">
                                ...
                                />
                                {errors.client_name && <FormErrorText errorText={errors.client_name.message} />}
                            </div>
                        </div>
                        ...
                        <div className="w-full grid grid-cols-1">
                            <div className="w-full relative flex flex-col gap-2">
                                ...
                                <Input
                                    ...
                                    {...register("client_location", { required: "Client Location is required" })}
                                />
                                {errors.client_location && <FormErrorText errorText={errors.client_location.message} />}
                            </div>
                        </div>
