...
const BannerBooking = ({bookingBanner}) => {
  return (
    <>
      <div className="relative">
        <div className="absolute top-[47px] left-[42px] md:left-[162px] w-[120px] md:w-[187px] z-50" style={{zIndex:9999999999}}>
          <Link href="/">
            <Image
        ...
        <CommonBanner backgroundImage={bookingBanner?.file_url ?? "/assets/images/booking-us-bg.png"} />
        <h1
