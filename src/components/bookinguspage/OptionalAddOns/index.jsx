...
const OptionalAddOns = ({optionalAddOn}) => {
  ...
  <div className="container px-4 md:px-0">
    ...
    <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6">
      <div className="flex flex-col justify-center items-center bg-[#1B1E25] w-full sm:max-w-[426px] h-auto md:h-[271px] p-6 md:p-12">
        <p className="font-bold text-base md:text-2xl text-white text-center">
          {optionalAddOn?.subsection1_title}
        </p>
        <p className="text-sm md:text-[16px] text-[#8F8F8F] text-center">
          {optionalAddOn?.subsection1_description}
        </p>
      </div>

      <div className="flex flex-col justify-center items-center bg-[#1B1E25] w-full sm:max-w-[426px] h-auto md:h-[271px] p-6 md:p-12 md:mt-[-179px]">
        <p className="font-bold text-base md:text-2xl text-white text-center">
          {optionalAddOn?.subsection2_title}
        </p>
        <p className="text-sm md:text-[16px] text-[#8F8F8F] text-center">
