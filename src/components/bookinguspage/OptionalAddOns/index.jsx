      ...
      <section className="bg-white relative overflow-hidden">
        ...
        <div className="container">
          <div className="flex flex-col justify-center items-center">
            <h3 className="text-[#0F1116] font-bold text-xl md:text-[45px] text-center mb-4 mt-5">
              {optionalAddOn?.title}
            </h3>
          ...
          <div>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-6 mt-[-66px]">
              <div className="flex flex-col space-y-4 justify-center items-center bg-white w-[426px] h-[271px] p-4 md:p-12 border-1 border-[#0F1116]">
                <p className="font-bold text-sm md:text-2xl text-[#0F1116] whitespace-nowrap">
              ...
              <div className="flex flex-col space-y-4 justify-center items-center bg-white w-[426px] h-[271px] p-4 md:p-12 md:mt-[-179px] border-1 border-[#0F1116]">
                <p className="font-bold text-sm md:text-2xl text-[#0F1116] whitespace-nowrap">
