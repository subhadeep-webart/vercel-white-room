    ...
    <section className="w-full h-screen relative bg-black" ref={containerRef}>
        ...
        <div className="text-lines">
          <div className="scroll-container">
            <div className="text-group">
              <h1 className="text">
                {
                  artists?.map((artist) => (<span className="word" key={artist?._id}>{artist?.artist_name}</span>))
                }
              </h1>
            </div>
            <div className="text-group">
      ...
      <div className="mask logo-mask" ref={maskRef}>
        <svg viewBox="480 800 280 150" className="logo" ref={svgRef}>
          ...
          />
          <path fill="#fff" d="M 483 819.087891 L 752.306885 819.087891 L 755 809 L 483 809 Z" />
          <path fill="#fff" d="M 483 825.055176 L 724.76947 825.055176 L 734 841.87207 L 483 841.87207 Z" />
          <path
            fill="#fff"
