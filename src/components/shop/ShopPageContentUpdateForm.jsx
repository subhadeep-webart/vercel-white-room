...
const ShopPageContentUpdateForm = ({ defaultValues = {}, refetch }) => {
  const { handleUpdateShopContent, loading: isUpdatingShopContent } =
    useUpdateShopContent(refetch);
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-end">
        <Button type="submit" className="w-32" disabled={isUpdatingShopContent}>
